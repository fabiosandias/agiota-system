...
const ClientsPage = () => {
    ...
    return (_jsxs("div", { className: "space-y-6", children: [_jsxs("section", { className: "flex flex-wrap items-center justify-between gap-4", children: [_jsxs("div", { children: [_jsx("h1", { className: "text-2xl font-semibold text-slate-900 dark:text-slate-100", children: "Clientes" }), _jsx("p", { className: "text-sm text-slate-500 dark:text-slate-400", children: "Gerencie os clientes cadastrados no sistema" })] }), _jsxs("div", { className: "flex items-center gap-3", children: [_jsxs("div", { className: "relative", children: [_jsx("input", { type: "search", placeholder: "Buscar por nome, documento, e-mail ou telefone...", value: pendingSearch, onChange: (event) => setPendingSearch(event.target.value), className: "w-80 rounded-xl border border-slate-300 bg-white px-4 py-2 pr-10 text-sm text-slate-900 outline-none transition focus:border-blue-500 focus:ring-2 focus:ring-blue-200 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-100" }), pendingSearch && pendingSearch !== searchTerm && (_jsx("div", { className: "absolute right-3 top-1/2 -translate-y-1/2", children: _jsx("div", { className: "h-4 w-4 animate-spin rounded-full border-2 border-blue-600 border-t-transparent" }) }))] }), _jsx("button", { onClick: () => setShowFilters(!showFilters), className: "rounded-xl border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-slate-700 shadow-sm transition hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-blue-400 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-200 dark:hover:bg-slate-700", children: _jsxs("span", { className: "flex items-center gap-2", children: [_jsx("svg", { className: "h-4 w-4", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: _jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M3 4a1 1 0 011-1h16a1 1 0 011 1v2.586a1 1 0 01-.293.707l-6.414 6.414a1 1 0 00-.293.707V17l-4 4v-6.586a1 1 0 00-.293-.707L3.293 7.293A1 1 0 013 6.586V4z" }) }), "Filtros", (filters.name || filters.city || filters.district) && (_jsx("span", { className: "flex h-5 w-5 items-center justify-center rounded-full bg-blue-600 text-xs text-white", children: [filters.name, filters.city, filters.district].filter(Boolean).length }))] }) }), canManageClients && (_jsx("button", { onClick: () => setShowNewClientForm(!showNewClientForm), className: "rounded-xl bg-emerald-600 px-4 py-2 text-sm font-semibold text-white shadow transition hover:bg-emerald-700 focus:outline-none focus:ring-2 focus:ring-emerald-400", children: "+ Novo Cliente" }))] })] }), canManageClients && showNewClientForm && (_jsxs("section", { className: "rounded-3xl border border-emerald-200 bg-white p-6 shadow-sm transition dark:border-emerald-500/40 dark:bg-slate-900", children: [_jsxs("div", { className: "flex flex-wrap items-start justify-between gap-4", children: [_jsxs("div", { children: [_jsx("h2", { className: "text-xl font-semibold text-emerald-700 dark:text-emerald-300", children: "Novo Cliente" }), _jsx("p", { className: "mt-1 text-sm text-emerald-700/80 dark:text-emerald-200/80", children: "Preencha os dados abaixo para cadastrar um novo cliente" })] }), _jsx("button", { type: "button", onClick: () => setShowNewClientForm(false), className: "rounded-xl border border-emerald-300 px-4 py-2 text-sm font-semibold text-emerald-700 transition hover:bg-emerald-50 focus:outline-none focus:ring-2 focus:ring-emerald-200 dark:border-emerald-500/60 dark:text-emerald-200 dark:hover:bg-emerald-500/10", children: "Cancelar" })] }), _jsxs("div", { className: "mt-6 space-y-4", children: [_jsx(ClientForm, { onSubmit: handleCreate, isSubmitting: createClient.isPending, onCancel: () => setShowNewClientForm(false) }), feedback && (_jsx("p", { className: "rounded-xl bg-green-50 px-4 py-3 text-sm font-medium text-green-600 dark:bg-green-500/10 dark:text-green-300", children: feedback })), errorMessage && (_jsx("p", { className: "rounded-xl bg-red-50 px-4 py-3 text-sm font-medium text-red-600 dark:bg-red-500/10 dark:text-red-300", children: errorMessage }))] })] })), canManageClients && editingClient && editingDefaults && (_jsxs("section", { className: "rounded-3xl border border-amber-200 bg-white p-6 shadow-sm transition dark:border-amber-500/40 dark:bg-slate-900", children: [_jsxs("div", { className: "flex flex-wrap items-start justify-between gap-4", children: [_jsxs("div", { children: [_jsx("h2", { className: "text-xl font-semibold text-amber-700 dark:text-amber-300", children: "Editar cliente" }), _jsx("p", { className: "mt-1 text-sm text-amber-700/80 dark:text-amber-200/80", children: "Atualize as informa\u00E7\u00F5es do cliente selecionado. As altera\u00E7\u00F5es s\u00E3o aplicadas imediatamente ap\u00F3s salvar." })] }), _jsx("button", { type: "button", onClick: handleCancelEdit, className: "rounded-xl border border-amber-300 px-4 py-2 text-sm font-semibold text-amber-700 transition hover:bg-amber-50 focus:outline-none focus:ring-2 focus:ring-amber-200 dark:border-amber-500/60 dark:text-amber-200 dark:hover:bg-amber-500/10", children: "Cancelar edi\u00E7\u00E3o" })] }), _jsx("div", { className: "mt-6", children: _jsx(ClientForm, { defaultValues: editingDefaults, onSubmit: handleUpdate, isSubmitting: updateClientMutation.isPending, resetAfterSubmit: false, submitLabel: "Atualizar cliente", onCancel: handleCancelEdit }) })] })), showFilters && (_jsx("div", { className: "fixed inset-0 z-50 flex items-start justify-center bg-black/50 pt-20", onClick: () => setShowFilters(false), children: _jsx("div", { className: "mx-4 w-full max-w-2xl", onClick: (e) => e.stopPropagation(), children: _jsxs("section", { className: "rounded-3xl border border-slate-200 bg-white p-6 shadow-xl dark:border-slate-800 dark:bg-slate-900", children: [_jsxs("div", { className: "mb-4 flex items-center justify-between", children: [_jsx("h3", { className: "text-lg font-semibold text-slate-900 dark:text-slate-100", children: "Filtros de pesquisa" }), _jsx("button", { type: "button", onClick: () => setShowFilters(false), className: "rounded-lg p-1 text-slate-400 transition hover:bg-slate-100 hover:text-slate-600 dark:hover:bg-slate-800 dark:hover:text-slate-200", children: _jsx("svg", { className: "h-5 w-5", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: _jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M6 18L18 6M6 6l12 12" }) }) })] }), _jsxs("form", { onSubmit: (e) => {
                                    handleFiltersSubmit(e);
                                    setShowFilters(false);
                                }, className: "space-y-4", children: [_jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-slate-600 dark:text-slate-300", children: "Nome" }), _jsx("input", { type: "text", value: pendingFilters.name, onChange: (event) => setPendingFilters((prev) => ({ ...prev, name: event.target.value })), className: "mt-2 w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 outline-none transition focus:border-blue-500 focus:ring-2 focus:ring-blue-200 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-100", placeholder: "Filtrar por nome" })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-slate-600 dark:text-slate-300", children: "Bairro" }), _jsx("input", { type: "text", value: pendingFilters.district, onChange: (event) => setPendingFilters((prev) => ({ ...prev, district: event.target.value })), className: "mt-2 w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 outline-none transition focus:border-blue-500 focus:ring-2 focus:ring-blue-200 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-100", placeholder: "Filtrar por bairro" })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-slate-600 dark:text-slate-300", children: "Cidade" }), _jsx("input", { type: "text", value: pendingFilters.city, onChange: (event) => setPendingFilters((prev) => ({ ...prev, city: event.target.value })), className: "mt-2 w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 outline-none transition focus:border-blue-500 focus:ring-2 focus:ring-blue-200 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-100", placeholder: "Filtrar por cidade" })] }), _jsxs("div", { className: "flex gap-3 pt-2", children: [_jsx("button", { type: "button", onClick: () => {
                                                    setPendingFilters({ name: '', city: '', district: '' });
                                                    setFilters({ name: '', city: '', district: '' });
                                                    setShowFilters(false);
                                                }, className: "flex-1 rounded-lg border border-slate-300 px-4 py-2 text-sm font-semibold text-slate-700 transition hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-slate-300 dark:border-slate-700 dark:text-slate-300 dark:hover:bg-slate-800", children: "Limpar filtros" }), _jsx("button", { type: "submit", className: "flex-1 rounded-lg bg-blue-600 px-4 py-2 text-sm font-semibold text-white shadow transition hover:bg-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-400", children: "Aplicar filtros" })] })] })] }) }) })), _jsx("section", { className: "space-y-6", children: _jsxs("div", { className: "rounded-3xl border border-slate-200 bg-white shadow-sm transition dark:border-slate-800 dark:bg-slate-900", children: [_jsxs("div", { className: "flex items-center justify-between border-b border-slate-200 px-4 py-3 text-xs text-slate-500 dark:border-slate-800 dark:text-slate-400", children: [_jsxs("div", { children: ["P\u00E1gina ", meta?.page ?? 1, " de ", totalPages, " \u00B7 ", meta?.total ?? clients.length, " clientes"] }), _jsxs("div", { className: "flex items-center gap-2", children: [_jsx("span", { className: "hidden md:inline", children: "Itens por p\u00E1gina" }), _jsx("select", { value: pageSize, onChange: (event) => handleChangePageSize(Number(event.target.value)), className: "rounded-lg border border-slate-300 bg-white px-2 py-1 text-xs text-slate-700 outline-none transition focus:border-blue-500 focus:ring-2 focus:ring-blue-200 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-100", children: [10, 20, 50].map((size) => (_jsx("option", { value: size, children: size }, size))) })] })] }), _jsx("div", { className: "overflow-x-auto", children: _jsxs("table", { className: "min-w-full divide-y divide-slate-200 text-sm dark:divide-slate-800", children: [_jsx("thead", { className: "bg-slate-50 dark:bg-slate-900/60", children: _jsxs("tr", { children: [_jsx("th", { className: "px-4 py-3 text-left font-medium text-slate-500 dark:text-slate-400", children: "Nome" }), _jsx("th", { className: "px-4 py-3 text-left font-medium text-slate-500 dark:text-slate-400", children: "Documento" }), _jsx("th", { className: "px-4 py-3 text-left font-medium text-slate-500 dark:text-slate-400", children: "Telefone" }), _jsx("th", { className: "px-4 py-3 text-left font-medium text-slate-500 dark:text-slate-400", children: "E-mail" }), _jsx("th", { className: "px-4 py-3 text-left font-medium text-slate-500 dark:text-slate-400", children: "Cidade" }), _jsx("th", { className: "px-4 py-3 text-left font-medium text-slate-500 dark:text-slate-400", children: "UF" }), _jsx("th", { className: "px-4 py-3 text-left font-medium text-slate-500 dark:text-slate-400", children: "Criado em" }), _jsx("th", { className: "px-4 py-3 text-left font-medium text-slate-500 dark:text-slate-400", children: "A\u00E7\u00F5es" })] }) }), _jsx("tbody", { className: "divide-y divide-slate-200 dark:divide-slate-800", children: isLoading || isFetching ? (_jsx("tr", { children: _jsx("td", { className: "px-4 py-6 text-center text-slate-500 dark:text-slate-400", colSpan: 8, children: "Carregando clientes..." }) })) : clients.length === 0 ? (_jsx("tr", { children: _jsx("td", { className: "px-4 py-6 text-center text-slate-500 dark:text-slate-400", colSpan: 8, children: "Nenhum cliente encontrado para os filtros atuais." }) })) : (clients.map((client) => {
