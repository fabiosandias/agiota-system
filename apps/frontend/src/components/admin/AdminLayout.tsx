      ...
      >
        ...
        <div className="flex items-center justify-between h-16 px-6 border-b border-slate-800">
          <Link to="/admin" className="flex items-center space-x-2">
            ...
            <span className="text-white font-semibold">AITRON Admin</span>
          </Link>
        </div>
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-slate-800">
          ...
          <button
            ...
            className="w-full flex items-center justify-center space-x-2 px-4 py-2 bg-slate-800 hover:bg-slate-700 text-slate-300 hover:text-white rounded-lg transition-colors"
          >
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex-1 max-w-2xl mx-8">
                <div className="relative">
                  <input
                    type="text"
                    placeholder="Buscar tenant por nome ou e-mail..."
